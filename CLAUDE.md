...
**P2 · Per-run economics + operability:** PR view, cost-per-review, cost_report reconciliation. Settings surface (CRUD): ingest token rotation/revocation from the UI, installation/org management, configurable session TTL. (Dashboard auth exists since P1: shared password, HMAC session cookies, 7-day expiry, logout.)
